...
const faqs = [
  ...
  ["Vilka svenska källor ingår?", "Startpaketet omfattar utvalda sidor och flöden hos Skatteverket, Försäkringskassan, Arbetsmiljöverket och Arbetsgivarverket. Källistan utvecklas utifrån stabilitet och kundbehov. Källor som kräver särskild API- eller webbläsaråtkomst aktiveras först när den anslutningen är verifierad."],
