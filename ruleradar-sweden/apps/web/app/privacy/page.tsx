...
export default function PrivacyPage() {
  ...
  const contactEmail = config.LEGAL_CONTACT_EMAIL || "privacy@ruleradar.se";
  return (
    <main className="inner-page legal-page">
      ...
      <article className="legal-copy">
        <h2>Personuppgiftsansvarig</h2><p>{legalEntity}{legalDetails ? `, ${legalDetails},` : ""} ansvarar för behandlingen av personuppgifter i tjänsten. Frågor skickas till <a href={`mailto:${contactEmail}`}>{contactEmail}</a>.</p>
        ...
        <h2>Kontakt</h2><p>Kontakta <a href={`mailto:${contactEmail}`}>{contactEmail}</a> för integritetsfrågor eller registrerades rättigheter.</p>
      </article>
    </main>
  );
}
