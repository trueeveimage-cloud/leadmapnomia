...
values
  ...
  ('gmail_autosend_body', $template$Hej {{owner_name}},
...
Leadmap.se$template$),
  ...
  ('gmail_autosend_body_sv', $template$Hej {{owner_name}},
...
Leadmap.se$template$),
  ...
  ('gmail_autosend_body_en', $template$Hi {{owner_name}},
...
Leadmap.se$template$),
  ...
  ('gmail_autosend_body_es', $template$Hola {{owner_name}},
